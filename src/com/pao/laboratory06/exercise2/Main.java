...
public class Main {
    public static void main(String[] args) {
        ...
        for (TipColaborator tipColab : TipColaborator.values()) {
            colaboratori.stream()
                    .filter(c -> TipColaborator.valueOf(c.tipContract()) == tipColab)
        ...
        for (Colaborator c : colaboratori) {
            typesOfCollaborators.add(TipColaborator.valueOf(c.tipContract()));
        }
        ...
        for (Colaborator c : colaboratori) {
            TipColaborator t = TipColaborator.valueOf(c.tipContract());
